...
### 📝 Latest Blog Posts
<!-- BLOG-POST-LIST:START -->- [Claude Opus 4.8 출시 정리 &mdash; Effort Control&middot;Dynamic Workflows&middot;코딩 정밀도 4배](https://hgko-dev.tistory.com/576) <sub>2026-06-02</sub>
...
- [Claude Max 3개월 진하게 써본 후기 &mdash; 월 $100 본전 뽑은 사용 패턴 7가지](https://hgko-dev.tistory.com/572) <sub>2026-05-20</sub>
<!-- BLOG-POST-LIST:END -->
